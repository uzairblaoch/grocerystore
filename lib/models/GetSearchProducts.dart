...
GetSearchProducts getSearchProductsFromJson(String str) =>
    GetSearchProducts.fromJson(json.decode(str));

String getSearchProductsToJson(GetSearchProducts data) =>
...
class GetSearchProducts {
  ...
  factory GetSearchProducts.fromJson(Map<String, dynamic> json) =>
      GetSearchProducts(
        status: json["status"],
